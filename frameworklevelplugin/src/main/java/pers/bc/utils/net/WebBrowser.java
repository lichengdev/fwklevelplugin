...
public class WebBrowser extends JFrame implements HyperlinkListener, PropertyChangeListener
{
    ...
    private static final long serialVersionUID = -7727314753236875459L;
    /** 下面是使用的Swing组件 **/
    ...
    /**
     * 实现PropertyChangeListener接口。处理属性改变事件。 显示HTML面板textPane的属性改变时，由该方法处理。 当textPane调用完setPage方法时，page属性便改变了。
     */
