...
/**
 * FTP相关的一些配置
 * @qualiFild nc.pub.itf.tools.ftp.FTPConstant.java<br>
 * @author：licheng<br>
 * @date Created on 2019-8-12<br>
 * @version 1.0<br>
 */
public abstract class FTPConstant
{
    /**
     * FTP状态码及其描述
     */
    ...
    // 用于编码转换
    public static String ISO_ECODING = "ISO-8859-1";
    // 程序运行的编码
    public static String PROJECT_ENCODING = PubConsUtilbc.UTF_8;
