...
/**
 * 
 * @qualiFild nc.pub.itf.tools.pub.RandomUtil.java<br>
 * @author：licheng<br>
...
public final class RandomUtil
{
     ...
     * @return 随机字符串
     */
    public static String StringDZ(int length)
    {
        StringBuilder sb = new StringBuilder();
        Random random = new Random();
        for (int i = 0; i < length; i++)
    ...
    public static String squid(String hostFeature)
    {
        ...
        String result = str + hostFeature + s.substring(17, 18) + s.substring(19, 23) + s.substring(24);
    ...
    public static <T> T randomItem(T[] param, double[] percentum)
    {
        ...
        Integer[] ints = PubEnvUtilbc.doubleBitCount(percentum);
        int max = Collections.max(Arrays.asList(ints));
        int[] arr = new int[length];
        int sum = 0;
        Map<Integer, int[]> map = new HashMap<Integer, int[]>(length);
