...
/**
 * Base64的编码和解码
 * @qualiFild pers.bc.utils.encrypt.Base64.java<br>
 * @author：licheng<br>
...
public class Base64
{
    ...
    public final static byte[] encodeToByte(String s) throws UnsupportedEncodingException
    {
        
        return encodeToByte(s.getBytes(PubConsUtilbc.UTF_8), false);
    }
    
    public final static byte[] encodeToByte(String s, boolean lineSep) throws UnsupportedEncodingException
    {
        
        return encodeToByte(s.getBytes(PubConsUtilbc.UTF_8), lineSep);
    ...
    public final static String decodeToString(byte[] arr) throws UnsupportedEncodingException
    {
        
        return new String(decode(arr), PubConsUtilbc.UTF_8);
    ...
    public final static String encodeToString(String s) throws UnsupportedEncodingException
    {
        
        return new String(encodeToChar(s.getBytes(PubConsUtilbc.UTF_8), false));
        
    }
    
    public final static String encodeToString(String s, boolean lineSep) throws UnsupportedEncodingException
    {
        
        return new String(encodeToChar(s.getBytes(PubConsUtilbc.UTF_8), lineSep));
    ...
    public final static String decodeToString(String s) throws UnsupportedEncodingException
    {
        return new String(decode(s), PubConsUtilbc.UTF_8);
    }
