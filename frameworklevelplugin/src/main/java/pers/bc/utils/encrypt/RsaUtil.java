...
/**
 * 实现RSA加密算法
 * @qualiFild nc.pub.itf.tools.encrypt.RsaUtil.java<br>
 * @author：licheng<br>
...
public final class RsaUtil
{
    ...
    public static String decryptDataWithPubKey(String data, String PUBLICKEY) throws Exception
    {
        ...
        return new String(decryptByPublicKey(rs, PUBLICKEY), PubConsUtilbc.UTF_8);
    }
    ...
    {
        byte[] rs = decryptBASE64(data);
        return new String(decryptByPrivateKey(rs, PRIVATEKEY), PubConsUtilbc.UTF_8);
    }
